...
function getCompanyID(){
    ...
    $OUTPUT_FILE= "-o ./Output/" +$COMPANYCODE+  "_batchcrack.out"
    return $OUTPUT_FILE
}
...
# Get Input File
Write-Host "Select the Input File"
...
# Current Hashcat Command String
#Write-Host "$HASHCAT $INPUT_FILE $FLAGS $COMPANYID"
